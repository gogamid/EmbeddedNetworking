...
\bibitem{b7} https://learn.adafruit.com/adafruit-bmp280-barometric-pressure-plus-temperature-sensor-breakout/arduino-test 
\bibitem{b8} https://learn.adafruit.com/adafruit-bmp280-barometric-pressure-plus-temperature-sensor-breakout
\bibitem{b9} https://i2c.info/
\end{thebibliography}
\vspace{12pt}
